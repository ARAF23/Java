...
//Bookstore class starts from here
public class BookStore {
    ...
    public BookStore(String name) {
        ...
        // adding population to the arraylist
        novels.add(null);
        novels.add(new Novel("The Adventures of Augie March", "Saul Bellow", 1953));
        novels.add(new Novel("All the King'ss Men", "Robert Penn Warren", 1946));
    ...
    // printing all the title in uppercase
    ...
    /*
     * @param parameter - substring, caseSensitive
     * 
     * @throws IllegalArgumentException if the substring parameter is null or blank
     */
        ...
        for (Novel novel : novels) {
            if (novel != null) {
                if (novel.getTitle() != null && !novel.getTitle().isEmpty()) {
                    ...
                    } else if ((novel.getTitle().toLowerCase().contains(substring.toLowerCase()))) {
                        System.out.println(novel.getTitle());
                    }
                }
            }
     ...
     * 
     * @throws IllegalArgumentException if the length parameter is 0 or negative
     */

    public void printAllTitles(int length) throws IllegalArgumentException {
        if (length <= 0) {
    ...
    public void printNameStartsEndsWith(String substring) throws IllegalNameException {
        ...
        for (Novel novel : novels) {
            if (novel != null && novel.getAuthorName() != null && !novel.getAuthorName().isEmpty()) {
                if (novel.getAuthorName().toLowerCase().startsWith(substring.toLowerCase())
     ...
     * 
     * @throws IllegalNovelPropertyException if its value is not "author" nor
     * "title"
     */
    ...
    public String getLongest(String property) throws IllegalNovelPropertyException {
        ...
        if (property.equalsIgnoreCase("author")) {
            for (Novel novel : novels) {
                if (novel != null && novel.getAuthorName() != null && !novel.getAuthorName().isEmpty()) {
                    if (longestname == null || longestname.length() < novel.getAuthorName().length())
                        longestname = novel.getAuthorName();
                }
            }
        } else if (property.equalsIgnoreCase("title")) {
            for (Novel novel : novels) {
                if (novel != null && novel.getTitle() != null && !novel.getTitle().isEmpty()) {
                    if (longestname == null || longestname.length() < novel.getTitle().length())
                        longestname = novel.getTitle();
                }
            }
        }
        return longestname;
    ...
    public static void main(String[] args) {
        ...
        try {
            BookStore b = new BookStore(args.length > 0 ? args[0] : "");
            // b.printAllTitles();\
            try {
                b.printTitlesContaining("", true);

            } catch (Exception e) {
                System.out.println(e.getMessage());
            }
            try {
                b.printTitlesContaining("", false);
