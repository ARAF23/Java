...
public class BookStore {
    ...
    // to show all the title of the given lenght

    public void printAllTitles(int length) {
        for (Novel novel : novels) {
    ...
    // Prints all author names that either start or end with substring
    ...
    // Returns are longest author/title name depending on situation
    public String getLongest(String property) {
        String longestname = null; // assuming initially the longest author is null
